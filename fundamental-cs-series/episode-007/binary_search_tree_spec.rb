...
describe 'BinarySearchTree' do
  ...
  describe '#delete' do
    ...
    context 'when deleting root node' do
      ...
      context 'with left child node only' do
        it 'should turn left child node into the new root node when it only has left child node' do
          bst = BinarySearchTree.new
          bst.insert(2)
          bst.insert(1)
          bst.delete(2)
        ...
        it 'should ensure left child node is removed from its position' do
          bst = BinarySearchTree.new
          bst.insert(2)
          bst.insert(1)
          bst.delete(2)
      ...
      context 'with two children nodes' do
        it 'should turn left most child node from its right subtree into the new root node' do
          bst = BinarySearchTree.new
          bst.insert(2)
          bst.insert(1)
          bst.insert(3)
   ...
   context 'when deleting child node' do
      ...
      context 'with two grandchildren nodes' do
        ...
        it 'should turn left most node from its right subtree into the new right child node' do
          bst = BinarySearchTree.new
          bst.insert(2)
          bst.insert(1)
          bst.insert(4)
